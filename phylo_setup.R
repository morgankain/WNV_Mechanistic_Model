###############################################################
### Functions for fitting phylogenetic mixed effects models ###
###############################################################
...
## Two functions for modifying structure of model for fitting 
...
## Fit generlaized linear mixed model
